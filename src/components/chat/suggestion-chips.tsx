...
import { Presentation, Image as ImageIcon, Film, Globe, BookOpen, Code } from 'lucide-react';
...
const suggestions = [
  ...
  { icon: Code, text: 'Code', prompt: 'Write a python function to calculate the factorial of a number, including error handling.' },
];
